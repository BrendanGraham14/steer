  ...
  outputs = { self, nixpkgs, rust-overlay, flake-utils, crane }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        mkCrateCrane = { name, cargoPackage ? name }: 
      ...
      in
      {
        packages = {
          ...
          conductor-workspace = craneLib.buildPackage (commonArgs // {
            inherit cargoArtifacts;
        ...
        checks = {
          ...
          conductor-clippy = craneLib.cargoClippy (commonArgs // {
            inherit cargoArtifacts;
          ...
          # Run tests
          conductor-tests = craneLib.cargoTest (commonArgs // {
            inherit cargoArtifacts;
          });
          ...
          # Check documentation
          conductor-doc = craneLib.cargoDoc (commonArgs // {
            inherit cargoArtifacts;
          });
