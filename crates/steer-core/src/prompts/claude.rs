...
pub fn claude_system_prompt() -> String {
    format!(
        r#"You are operating within an interactive tool called Steer that helps users with software engineering tasks. Use the instructions below and the tools available to you to assist the user.
