        ...
        TaskOutcome::BashCommandComplete {
            ...
            match result {
                ...
                Err(e) => {
                    ...
                    if matches!(e, steer_tools::ToolError::Cancelled(_)) {
...
fn get_model_system_prompt(model_id: ModelId) -> String {
    ...
    if provider_str == crate::config::provider::OPENAI_ID
        && (model_str == "o3-2025-04-16"
            || model_str == "gpt-5-2025-08-07"
            || model_str == "gpt-4.1-2025-04-14"
            || model_str == "o4-mini-2025-04-16"
            || model_str == "codex-mini-latest")
    {
        crate::prompts::o3_system_prompt()
    } else if provider_str == crate::config::provider::XAI_ID
        && model_str == "grok-4-0709"
    {
        crate::prompts::o3_system_prompt()
