...
impl From<&conductor_tools::ExecutionContext> for SerializableExecutionContext {
    fn from(context: &conductor_tools::ExecutionContext) -> Self {
        Self {
...
fn convert_tool_response(response: ExecuteToolResponse) -> Result<ToolResult> {
    use conductor_proto::remote_workspace::v1::execute_tool_response::Result as ProtoResult;
