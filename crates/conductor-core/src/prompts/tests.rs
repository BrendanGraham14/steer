...
mod tests {
    ...
    fn test_default_prompt() {
        ...
        assert!(content.contains("You are Conductor"));
    ...
    fn test_selector_to_prompt() {
        ...
        assert!(default_prompt.system_prompt().contains("You are Conductor"));

        let gemini_prompt = PromptSelector::Gemini.to_prompt();
        assert!(gemini_prompt.system_prompt().contains("You are Conductor"));
